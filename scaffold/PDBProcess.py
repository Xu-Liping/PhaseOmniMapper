...
positive_folder = './scaffold_PDB'  
negative_folder = './non-LLPS_human_PDB'  
...
# combined_data = positive_data
df = pd.DataFrame(combined_data)


df.to_csv('./data.csv', index=False)  #path to your prepared data_to_load folder